...
export default function GridImageCard({ image, description }: { image: string; description: string }) {
  return (
    <div className="flex flex-col items-center flex-grow-0 w-full sm:w-[48%] lg:w-[30%]">
      <div className="relative w-full h-[180px] md:h-[200px] rounded-2xl overflow-hidden">
        <Image src={image} alt={description || ''} fill className="object-contain shadow-md" />
      </div>
