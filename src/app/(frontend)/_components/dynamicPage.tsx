  ...
  export default function DynamicPage({ slug }: DynamicPageProps) {
    ...
    useEffect(() => {
      const fetchData = async () => {
        try {
          ...
          const navbarData = await getDataNavbar()
    ...
    const renderSection = (section: any, index: number) => {
      switch (section.blockType) {
        ...
        case 'gridImageSection':
          return <GridImage key={index} data={section} domainBlob={domainBlob} />
        case 'iconListWithSideImagesSection':
          return <IconListWithSideImages key={index} data={section} domainBlob={domainBlob} />
        default:
          return <NotFound />
      }
    }
    ...
    return (
      <div>
        {fetchedNavbar && <Navbar data={fetchedNavbar} domainBlob={domainBlob} getLucideIcon={getLucideIcon} />}
