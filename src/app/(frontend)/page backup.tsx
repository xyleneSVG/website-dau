...
import Service from './_components/_layouts/service'
import Tech from './_components/_layouts/tech'
import Product from './_components/_layouts/product'
import Client from './_components/_layouts/client'
import Message from './_components/_layouts/message'
...
import { getDataFieldMessages } from './_functions/getDataFieldMessages'
...
export default function HomePage() {
  ...
  const [fieldMessages, setFieldMessages] = useState<any[]>([])
  ...
  useEffect(() => {
    ...
    const fetchDataFieldMessages = async () => {
      const result = await getDataFieldMessages()
    ...
    <AnimatePresence mode="wait">
      {fetching ? (
        ...
        >
          ...
          <Message fieldMessages={fieldMessages} />
        </motion.div>
      )}
    </AnimatePresence>
  )
